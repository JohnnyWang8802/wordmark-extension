...
const translations: Record<string, Record<string, string>> = {
  ...
  'card.regenerate': { en: 'Use AI to optimize', zh: '使用 AI 优化' },
  'card.regenerating': { en: 'Improving...', zh: '正在优化...' },
  'card.regenerateFailed': { en: 'AI improvement failed. Check AI settings.', zh: 'AI 优化失败，请检查 AI 设置。' },
  'card.regenerateFailedShort': { en: 'Failed', zh: '优化失败' },
  'card.tags': { en: 'Tags', zh: '标签' },
  'card.addTag': { en: 'Add tag...', zh: '添加标签...' },
  'source.dictionary': { en: 'Local dictionary', zh: '本地词典' },
  'source.freeTranslation': { en: 'Free translation', zh: '免费翻译' },
  'source.ai': { en: 'AI', zh: 'AI' },
  'source.definition': { en: 'Definition', zh: '释义' },
  'source.translation': { en: 'Translation', zh: '翻译' },
  ...
  'settings.aiLookup': { en: 'AI Enhanced Lookup', zh: 'AI 增强查词' },
  'settings.aiLookupHint': { en: 'Use any Chat Completions compatible model to improve missing or context-sensitive definitions.', zh: '使用兼容 Chat Completions 的大模型优化查不到或需要上下文判断的释义。' },
  'settings.aiMode': { en: 'AI Mode', zh: 'AI 模式' },
  'settings.aiModeFallback': { en: 'Use AI to optimize', zh: '使用 AI 优化' },
  'settings.aiModeAlways': { en: 'Always use AI', zh: '始终使用 AI' },
  'settings.aiModel': { en: 'Model', zh: '模型' },
  'settings.aiBaseUrl': { en: 'API Base URL', zh: 'API Base URL' },
  'settings.aiBaseUrlHint': { en: 'Supports /v1/chat/completions compatible providers.', zh: '支持兼容 /v1/chat/completions 的服务商。' },
  'settings.aiApiKey': { en: 'API Key', zh: 'API Key' },
  'settings.aiPrivacy': { en: 'Stored locally. Selected text and context may be sent when AI lookup runs.', zh: '密钥仅存本地。AI 查词运行时可能会发送选中文本和上下文句子。' },
